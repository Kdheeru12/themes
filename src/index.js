...
// Features
import Layout from './stores/covers/Layout';
...
import Login from './stores/Users/Login';
...
import ProductHome from './stores/components/ProductsHome';
import Checkout from './stores/components/Checkout';
import Signup from './stores/Users/Signup';
				...
				<BrowserRouter basename={'/'} >
					<ScrollContext>
						<Switch>
                            ...
                            <Route path={`${process.env.PUBLIC_URL}/pages/register`} component={Signup}/>
                            <Layout>
                                ...
                                <Route path={`${process.env.PUBLIC_URL}/pages/faq`} component={ProductHome}/>
